	  ...
	  (0, _createClass3.default)(MainSection, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h2',
	          { className: _style2.default.sum, title: _config.currency.name },
	          cost
	        )
	      );
	    }
